...
public class MaterialButton extends JButton {
	...
	public MaterialButton(String text) {
		this(text, UIManager.getColor("Button.background"), UIManager.getColor("Button.foreground"),
				UIManager.getColor("Button.highlight"));
	}

	public MaterialButton(Icon icon) {
		this(icon, UIManager.getColor("Button.background"), UIManager.getColor("Button.foreground"),
				UIManager.getColor("Button.highlight"));
	}
